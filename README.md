...
| [Credit Risk Analysis](https://github.com/teresa-le/Credit_Risk_Analysis) | Python 
|[Cryptocurrencies](https://github.com/teresa-le/Cryptocurrencies/tree/main)  | Python, Data Wrangling, Machine Learning (Clustering) | I found and grouped similar cryptocurrencies that were being traded using a unsupervised machine learning technique. | pandas, path, plotly, sklearn 
